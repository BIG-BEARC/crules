...
> **状态**：**批 1 / 2a / 2b / 2c / 3a / 4 已完成**（2026-08-27，crules-flutter 0.1.3 + crules v76）；唯**批 3b（saas_pos 瘦身）按方案等新规则稳定运行后执行**。执行留痕见两仓 CHANGELOG/评审与 crules-flutter `docs/fork-coverage.md`。
